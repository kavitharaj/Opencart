...
public class dataProvides extends excelUtility {
	 ...
	 * 
	 * return new String[][] {{"abc123@gmail.com","test@123","valid"},
	 * {"abc","123","invalid"}};}
	 */
	/*
	 * public dataProvides(String path) { super(path); // TODO Auto-generated
	 * constructor stub }
	 */
	 ...
	 * public String[][] getdata(){
	 * 
	 * String logindata[][]= {{"abc123@gmail.com","test@123","valid"},
	 * {"abc","123","invalid"}}; return logindata;
	 */

	public String[][] getdata() throws IOException, FileNotFoundException {

		try {
			String Path = System.getProperty("user.dir") + "\\tetdata\\\\logindata.xlsx";
